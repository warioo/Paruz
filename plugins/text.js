...
Asena.addCommand({pattern: 'meenu', fromMe: false,dontAddCommandList: true}, (async (message, match) => {

    var r_text = new Array ();    
r_text[0] = "\nEda eda, mandankonappi.. Nee enne kooduthal mandan aakkatheda\n";
r_text[1] = "Paathune tholpikkaan ningalkavilla. Jeevitathil Paathune tholpichittundu… palarum… palavattom…😥😥 aarellum aaa sed bgm onn iduo...";
r_text[2] = "meenu says i love you 😘";
r_text[3] = "Paathunte yudhangal Company Kanan Povunnatheyuloo";
r_text[4] = "hi, how are you";
r_text[5] = "ennikk korch rest theroo...🥵🥵";
r_text[6] = "Paathu - eva - simsim \ningane ethra ethra paerugal aan alle enikk..😂🤣";
...
r_text[8] = "\n enne vilicho...?🧐 \n";
r_text[9] = "ente per Paathu ,ninte per donkey, baaki ellarum monkey😼😼";
r_text[10] = "nee vilicha enikk vili kelkathe irrikkaan pattuo";
r_text[11] = "do you know who is my creator..? its none other than Fasil";
...
r_text[13] = ".song adich thangalude fav song name para Paathu ath download aakki theraam👩🏻";
...
r_text[18] = "enikk njan und paathu uyir💁🏻‍♀️";
r_text[19] = "\n eda sathyam para nee ente fan alle..🧚🏻‍♂️\n ";
...
r_text[21] = "Kozhikode pazhaya kozhikkodallennariyam… pakshe Paathu pazhaya Paathu thanneya...😎\n\n";
r_text[22] = "Kaanaan oru look illanney ullu… bhayankara budhiya\n\n ninnak allatto enik paathuvinu";
r_text[23] = "Ithalla ithinapparam chaadi kadannavananee K.K. Paathu";
